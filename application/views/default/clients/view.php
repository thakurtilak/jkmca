<div class="view_order_info">
    ...
    <?php if(isset($jobDocuments) && count($jobDocuments)): ?>
        <div class="box-form">
            <div class="theme-form">
                <h3 class="form-box-title">Job Documents History</h3>
                <div class="ims_datatable table-responsive" style="background: #FFFFFF; max-height: 200px;">
                    <!-- <h3 class="form-box-title">Client Details </h3>-->
                    <table id="clientList" class="table table-striped table-bordered table-condensed table-hover"
                           cellspacing="0" width="100%">
                        <thead>
