<div class="view_order_info">
    ...
    <!--Invoice Details-->
   <?php if($invoiceDetail->invoice_acceptance_flag == 'Y' || $invoiceDetail->invoice_acceptance_status=='Accept' && (strtolower($invoiceDetail->gen_approval_status) == "accept" || empty ($invoiceDetail->gen_approval_userid))){?>
...
<?php } ?>
    ...
    if($invoiceDetail->gen_approval_status == 'Accept') :
     if(in_array(GENERATERROLEID , $userRole) || in_array(COLLECTORROLEID , $userRole)) : ?>
