...
<tr>
    <td>New Job Request with JOB ID <strong><?php echo $jobDetail->job_number; ?></strong> has been <?php echo $updatedMode; ?> and assign to <strong><?php echo $staffName; ?></strong> . Below are the JOb details:</td>
</tr>
<tr>
    <td>&nbsp;</td>
</tr>
<tr>
    <td><table width="800" border="0">
            ...
            <tr>
                <td width="200"><strong>Tentative Completion Date</strong></td>
                <td>:</td>
                <td><?php echo (property_exists($jobDetail, 'completion_date') && !empty($jobDetail->completion_date))? date('d-M-Y', strtotime($jobDetail->completion_date)):""; ?>  </td>
            </tr>
            <tr>
