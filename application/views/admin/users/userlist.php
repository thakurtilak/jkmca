                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group text-right">
                            <a href="<?php echo base_url('admin/users/add'); ?>"  class="mdl-js-button mdl-js-ripple-effect btn-view action-btn">Add New</a>
                        </div>
                    </div><!--col-sm-3-->
                </div><!--row-->
            </div><!--order_filter-->
