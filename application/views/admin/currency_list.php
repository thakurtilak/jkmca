            ...
            <td width="100%" align="left" valign="top">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="h_bg">
                    <tr>
                        ...
                        <td >
                            <img src="<?php echo base_url();?>assets/images/ico_ma.gif" width="14" height="14" align="absmiddle" />&nbsp; Currency List</td>
                        <td width="7">
                ...
                <table width="100%" border="0" align="center" class="mainborder" style="padding:0px;" >
                    ...
                    <tr>
                        <td colspan="6" align="left" width="50%" id="userlist">
                            ...
                            <table width="100%" height="20" border="0" align="left" cellpadding="4" cellspacing="1" bgcolor="#AFBACF" id="data">
