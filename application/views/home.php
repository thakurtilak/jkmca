...
<head>
    ...
    <title>JKMCA</title>
    <link rel="stylesheet" href="<?php echo base_url('assets/default/');?>css/components.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/default/');?>css/icons.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/default/');?>css/responsee.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/default/');?>owl-carousel/owl.carousel.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/default/');?>owl-carousel/owl.theme.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/default/');?>css/template-style.css">
    <link href='https://fonts.googleapis.com/css?family=Playfair+Display&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,300,700,800&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
    <script type="text/javascript" src="<?php echo base_url('assets/default/');?>js/jquery-1.8.3.min.js"></script>
    <script type="text/javascript" src="<?php echo base_url('assets/default/');?>js/jquery-ui.min.js"></script>
</head>
...
<header role="banner" class="position-absolute">
    <!-- Top Navigation -->
    <nav class="background-transparent background-transparent-hightlight full-width sticky fixed">
        <div class="s-12 l-2">
            <a href="/" class="logo">
                <!-- Logo White Version -->
                <img class="logo-white" src="<?php echo base_url('assets/default/');?>img/logo_2.png" alt="">
                <!-- Logo Dark Version -->
                <img class="logo-dark" src="<?php echo base_url('assets/default/');?>img/logo_2.png" alt="">
            </a>
        </div>
...
<main role="main">
    ...
    <header>
        <div class="carousel-default owl-carousel carousel-main carousel-nav-white background-dark text-center">
            <div class="item">
                <div class="s-12">
                    <img src="<?php echo base_url('assets/default/');?>img/header.jpg" alt="">
    ...
    <section class="full-width">
        <div class="s-12 m-12 l-6">
            <img src="<?php echo base_url('assets/default/');?>img/img-12.jpg" alt="">
        </div>
        <div class="s-12 m-12 l-6">
    ...
    <section class="section background-white text-center">
        <div class="line">
            ...
            <div class="carousel-default owl-carousel carousel-wide-arrows">
                ...
                <div class="item">
                    <div class="s-12 m-12 l-7 center text-center">
                        <img class="image-testimonial-small" src="<?php echo base_url('assets/default/');?>img/testimonials-05.png" alt="">
                        <p class="h1 margin-bottom text-size-20">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis</p>
                ...
                <div class="item">
                    <div class="s-12 m-12 l-7 center text-center">
                        <img class="image-testimonial-small" src="<?php echo base_url('assets/default/');?>img/testimonials-06.png" alt="">
                        <p class="h1 margin-bottom text-size-20">Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis</p>
...
<script type="text/javascript" src="<?php echo base_url('assets/default/');?>owl-carousel/owl.carousel.js"></script>
...
<script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAYK98rTeHAkmnLpyraPAUvZYLRGh8Xaxc&callback=initMap">
</script>
<style>
    #map {
        height: 400px;
