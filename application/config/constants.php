...
define('TBL_CLIENT_SALESPERSON', 'ims_client_sales_person');
define('TBL_CLIENT_ACCOUNTPERSON', 'ims_client_account_person');
define('TBL_CLIENT_AGREEMENTS', 'ims_client_agreements');
